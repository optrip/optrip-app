...
export function BirthYearScreen() {
  ...
  const initialYear =
    profile.birthYear && YEARS.includes(profile.birthYear) ? profile.birthYear : '2006';
      ...
      <Animated.View style={[styles.flex, { opacity }]}>
        ...
        <View style={styles.body}>
          <View style={styles.titleSection}>
            ...
            <Text style={styles.subtitle}>나중에 프로필에서 수정할 수 있어요.</Text>
          </View>
        ...
        <View style={styles.footer}>
          <PrimaryButton label="완료" onPress={submit} disabled={!selectedYear} />
        </View>
      </Animated.View>
    </SafeAreaView>
  );
