...
const styles = StyleSheet.create({
  ...
  detailButton: { alignSelf: 'flex-end', flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.8)', paddingVertical: 8, paddingHorizontal: 15, borderRadius: 20 },
  detailText: { fontSize: 12, fontWeight: '600', marginRight: 5 },
  bottomBar: { height: 80, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingBottom: 20 },
  mainMarker: { marginTop: -40, backgroundColor: '#fff', borderRadius: 50, padding: 12, elevation: 5 },
});